            ...
            <div class="col-lg-12">
                ...
                <form class="form-horizontal" role="form" action="vorlesung_create_do.php" method="post">
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <input type="number" class="form-control" name="vorlesungsnummer" id="vorlesungsnummer"
                    ...
                    <div class="form-group">
                        <div class="col-sm-6">
                            <input type="text" class="form-control" name="vorlesungsname" id="vorlesungsname"
