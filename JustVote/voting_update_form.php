        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <form action='voting_update_do.php' method='post'>
                    ...
                    <input type='text' name='antwort_2' value='<?php echo $antworten[1]->text ?>'
                           required="required"/><br>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="date" name="startdatum" placeholder="Startdatum"
                               required="required" value='<?php echo $startDatum ?>'/>
                        <input class="form-control" type="time" name="startzeit" placeholder="Startzeit"
                               required="required" value='<?php echo $startZeit ?>'/>
                    </div>
